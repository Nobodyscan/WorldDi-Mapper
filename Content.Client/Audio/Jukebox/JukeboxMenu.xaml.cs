...
public sealed partial class JukeboxMenu : FancyWindow
{
    ...
    protected override void FrameUpdate(FrameEventArgs args)
    {
        ...
        {
            var resolved = new ResolvedPathSpecifier(audio.FileName);
            DurationLabel.Text = $@"{TimeSpan.FromSeconds(audio.PlaybackPosition):mm\:ss} / {_audioSystem.GetAudioLength(resolved):mm\:ss}";
        }
        else
        {
